...
//Hardware definition
class Top_VIP_ICE40(val withLcd: Boolean, val ramFile: String, val romFile: String) extends Component {
    val io = new Bundle {
        val reset_ = in Bool()
...
object Top_VIP_ICE40_Verilog extends App {
  Config.spinal.generateVerilog(new Top_VIP_ICE40(false, "./data/test_1861.bin", "./data/vip.rom"))
}